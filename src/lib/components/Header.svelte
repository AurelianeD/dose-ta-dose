...
<header>
    ...
    <nav class:open={isMenuOpen}>
        <div class="btn-nav mobile-nav" style="display: {isMenuOpen ? 'flex' : 'none'};">
            <button class="nav-style" on:click={() => {goto('about'); toggleMenu();}}>à propos</button>
            <hr>
            <button class="nav-style" on:click={() => {goto('guideAtelier'); toggleMenu();}}>organiser un atelier</button>
            <hr>
            <button class="nav-style" on:click={() => {goto('/#jeu'); toggleMenu();}}>Le jeu</button>
            <hr>
            <button class="nav-style" on:click={() => {goto('ressources'); toggleMenu();}}>ressources</button>
            <hr>
        </div>
    </nav>
</header>
